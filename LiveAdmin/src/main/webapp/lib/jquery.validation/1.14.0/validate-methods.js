...
$(function(){
    ...
    jQuery.validator.addMethod("isPrice", function(value, element) { 
    	return this.optional(element) || /^[0-9]{0,10}[.]{0,1}[0-9]{0,2}$/.test(value);   
    }, "请填写正确的价格，例：999.99");
    
    // 判断是否为正确的折扣格式
    jQuery.validator.addMethod("isDiscountrate", function(value, element) { 
    	return this.optional(element) || /^[0-1]{1}[.][0-9]{0,2}$/.test(value);   
    }, "请填写正确的折扣，例：0.01-0.99"); 
