...
<body>
	<header class="navbar-wrapper">
		<div class="navbar navbar-fixed-top">
			<div class="container-fluid cl">
				...
				<span class="logo navbar-slogan f-l mr-10 hidden-xs">后台系统</span> <a
				...
				<nav id="Hui-userbar"
					...
					<ul class="cl">
						<li class="dropDown dropDown_hover">
							<a href="#" class="dropDown_A">和讯  <i class="Hui-iconfont">&#xe6d5;</i></a>
							<ul class="dropDown-menu menu radius box-shadow">
								<li><a href="${pageContext.request.contextPath}/hexunlogout">退出</a></li>
							</ul>
						</li>
	...
	<aside class="Hui-aside">
		<div class="menu_dropdown bk_2">
			<dl id="menu-tell">
				<dt>
					<a data-href="chatmanage?type=tell" data-title="通话记录管理" href="javascript:void(0)">
						|- 通话记录管理
					</a>
				</dt>
			</dl>
			<dl id="menu-chat">
				<dt>
					<a data-href="chatmanage" data-title="聊天记录管理" href="javascript:void(0)">
						|- 聊天记录管理
					</a>
				</dt>
			</dl>
