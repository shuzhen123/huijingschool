 ...
 %>
	...
	<div class="loginWraper">
		<div id="loginform" class="loginBox">
			<form class="form form-horizontal" action="loginaction.do" method="post">
				<div class="row cl">
				...
				<div class="row cl">
					<div class="formControls col-xs-8 col-xs-offset-3">
						...
						<img src="verifycode.do"> <a id="kanbuq" href="javascript:;">看不清，换一张</a>
					</div>
				</div>
				<div class="row cl">
					<div class="formControls col-xs-8 col-xs-offset-3">
	...
	<script>
		$(function() {
			$("#kanbuq").click(function() {
				$("img").attr("src","verifycode.do?" + Math.random());
			});
