...
<article class="page-container">
	<form action="addchatinfo" method="post" class="form form-horizontal" id="form">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">客户账号：</label>
			<div class="formControls col-xs-4 col-sm-4">
				<select id="account" name="customerid" style="width: 100%;">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">聊天记录：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="content" cols="" rows="15" class="textarea"  placeholder="请填写简介" style="height: auto;"></textarea>
			</div>
		</div>
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
				<c:choose>
					...
					<c:otherwise><span style="color: red;">您没有可维护的客户，无法发布聊天记录</span></c:otherwise>
				</c:choose>
			</div>
		</div>
	</form>
