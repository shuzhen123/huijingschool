...
<body>
	<header class="navbar-wrapper">
		<div class="navbar navbar-fixed-top">
			<div class="container-fluid cl">
				...
				<span class="logo navbar-slogan f-l mr-10 hidden-xs">业务员系统</span> <a
	...
	<aside class="Hui-aside">
		<div class="menu_dropdown bk_2">
			<dl id="menu-user">
				<dt>
					<a data-href="customerpool" data-title="客户资源池" href="javascript:void(0)">
						|- 客户资源池
					</a>
				</dt>
			</dl>
			<dl id="menu-user">
				<dt>
					<a data-href="customer" data-title="客户管理" href="javascript:void(0)">
						|- 客户管理
					</a>
				</dt>
			</dl>
			<dl id="menu-popu">
				...
				<dd>
					<ul>
						<li><a data-href="salerpopu?type=1"
							data-title="二维码推广" href="javascript:void(0)">二维码推广</a></li>
						<li><a data-href="salerpopu?type=2"
							data-title="直播间推广" href="javascript:void(0)">直播间推广</a></li>
					</ul>
				</dd>
			</dl>
			<dl id="menu-note">
				<dt>|- 通话管理 <i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
				<dd>
					<ul>
						<li><a data-href="chatrecord?type=2"
							data-title="通话录音管理" href="javascript:void(0)">通话录音管理</a></li>
						<li><a data-href="chatrecord?type=1"
							data-title="文字聊天管理" href="javascript:void(0)">文字聊天管理</a></li>
					</ul>
				</dd>
			</dl>
			<dl id="menu-statement">
				...
				<dd>
					<ul>
						<li><a data-href="dashboardstatistics"
							data-title="直播消费" href="javascript:void(0)">直播消费</a></li>
