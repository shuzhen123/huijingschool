...
<article class="page-container">
	<form action="addTrackRecord?userid" method="post" enctype="multipart/form-data" class="form form-horizontal" id="form">
		<!-- 获取用户id ： 不显示 -->
		...
		<input type="text" name="record" class="hidden">
...
$(function(){
	...
	$("#form").validate({
		...
		submitHandler:function(form){
			...
			$('input[name="record"]').val(ue.getContent());
