...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页  <span class="c-gray en">&gt;</span> 直播课程管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
$(function(){
    ...
    $("body").on("click", "a.add-live-course", function() {
    	layer_show('直播课程添加', 'addlivecoursepage','','510');
    })
    //直播课程修改
    $("body").on("click", "a.course-edit", function() {
    	var sData = api_table.fnGetData( $(this).parents("tr") );
    	layer_show('直播课程修改','editlivecoursepage?courseid='+sData.courseid,'','510');
    })
    
    //直播课程详情
    $("body").on("click", "a.course-detail", function() {
    	var sData = api_table.fnGetData( $(this).parents("tr") );
    	var href = 'livecoursedetail?courseid=' +sData.courseid;
