...
<body>
	<header class="navbar-wrapper">
		<div class="navbar navbar-fixed-top">
			<div class="container-fluid cl">
				...
				<span class="logo navbar-slogan f-l mr-10 hidden-xs">讲师系统</span> <a
	...
	<aside class="Hui-aside">
		<div class="menu_dropdown bk_2">
			<dl id="menu-course">
				<dt>
					<a data-href="course" data-title="课程管理" href="javascript:void(0)">
						|- 课程管理
					</a>
				</dt>
			</dl>
			<dl id="menu-live">
				<dt>
					<a data-href="livecourse" data-title="直播课程管理" href="javascript:void(0)">
						|- 直播课程管理
					</a>
				</dt>
			</dl>
			<dl id="menu-vipnew">
				<dt>
					<a data-href="vipnews" data-title="VIP资讯管理" href="javascript:void(0)">
						|- VIP资讯管理
					</a>
				</dt>
			</dl>
			<dl id="menu-dashboardviewpoint">
				<dt>
					<a data-href="dashboardviewpoint" data-title="牛人观点管理" href="javascript:void(0)">
						|- 牛人观点
					</a>
				</dt>
			</dl>
