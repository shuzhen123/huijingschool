...
<div class="page-container">
	<div id="tab-system" class="HuiTab">
		...
		<div class="tabCon">
			<form class="form form-horizontal" id="base-form" enctype="multipart/form-data" action="editselfinfo" method="post">
				...
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">讲师姓名：</label>
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-2 col-sm-2" data-name="cidpassword">
						${userinfo.cidpassword }
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">头像：</label>
					<div class="formControls col-xs-2 col-sm-2" data-icon="iconurl">
						<img src="${userinfo.iconurl }" alt="头像" class="round" style="max-height: 80px;">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">讲师展示图：</label>
					<div class="formControls col-xs-2 col-sm-2" data-icon="teacherurl">
						<img src="${userinfo.teacherurl }" alt="展示图" class="thumbnail" style="max-height: 100px;">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">简介：</label>
					<div class="formControls col-xs-2 col-sm-2" data-textarea="introduction">
...
$(function(){
	...
	$("button.edit").click(function() {
		...
		$('#base-form div[data-icon="iconurl"]').append(
			...
			'	</span>'+
			'</div>');
		$('#base-form div[data-icon="teacherurl"]').append(
			'<div style="margin-top: 10px;">'+
			'	<span class="btn-upload form-group">'+
			'		<input class="input-text upload-url" type="text" name="uploadfile" id="uploadfile" readonly nullmsg="请添加附件！" style="width:100px">'+
	...
	$("button.cancel").click(function() {
		...
		$('#base-form div[data-icon="iconurl"]').find("div").remove();
		$('#base-form div[data-icon="teacherurl"]').find("div").remove();
		$(this).addClass('hidden');
