...
<article class="page-container">
	<form action="addteacher" method="post" enctype="multipart/form-data" class="form form-horizontal" id="form">
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">讲师姓名：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="请填写讲师姓名" name="realname">
			</div>
		</div>
		<div class="row cl">
