...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页  <span class="c-gray en">&gt;</span> 讲师管理  <span class="c-gray en">&gt;</span> 上传课程管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
$(function(){
            ...
            {"data": "createtime"},
            {
                ...
                "render": function (base_data, type, full) { 
                     var str = '<a style="text-decoration:none" class="ml-5 course-detail" href="javascript:;" title="查看详情">' +
	                    ...
	                    '</a> '+
	                    '<a title="课程视频详情" href="javascript:;" class="ml-5 course-video" style="text-decoration:none">' +
	                    '	<i class="Hui-iconfont" style="color: #3bb4f2;">&#xe6c2;</i>' +
	                    '</a> ';
                	return  str;
                }
    ...
    $("body").on("click", "a.course-edit", function() {
    	var sData = api_table.fnGetData( $(this).parents("tr") );
    	layer_show('课程修改','${pageContext.request.contextPath}/tea/coursedata?type=edit&courseid='+sData.courseid,'','510');
    })
    ...
    $("#datatable").on('click', '.course-comment', function() {
    	...
    	var index = layer.open({
    		...
    		content: '${pageContext.request.contextPath}/tea/coursecommentpage?courseid=' +sData.courseid
    	});
    	layer.full(index);
	})
