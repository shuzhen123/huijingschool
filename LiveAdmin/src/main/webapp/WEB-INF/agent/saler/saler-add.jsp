...
<article class="page-container">
	<form action="saleradd" method="post" class="form form-horizontal" id="form">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="请填写密码" name="password">
			</div>
		</div>
		<div class="row cl">
				...
				<span class="select-box" style="width:auto;">
					<select class="select" name="levelid" size="1">
						...
						<c:forEach var="item" items="${level }">
							<option value="${item.id}" >${item.levelname }（${item.limitpeople }人）</option> 
						</c:forEach>
					</select>
				</span>
			</div>
