...
<article class="page-container">
	<form action="addviewpoint" method="post" class="form form-horizontal" id="form">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">观点标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="请输入观点标题" name="infomationtitle">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">观点描述：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="descrption" cols="" rows="" class="textarea"  placeholder="观点描述" ></textarea>
			</div>
		</div>
		<div class="row cl">
