...
<article class="page-container">
	<form action="editagent" method="post" class="form form-horizontal" id="form">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${userInfo.telno }" placeholder="请填写手机号码" name="telno">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">代理商名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${userInfo.realname }" placeholder="请填写真实姓名" name="realname">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">渠道区分代码：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${userInfo.agentcode }" placeholder="请填写渠道区分代码" name="agentcode">
			</div>
		</div>
		<div class="row cl">
