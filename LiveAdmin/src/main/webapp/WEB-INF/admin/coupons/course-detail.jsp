...
<article class="page-container">
	<form class="form form-horizontal">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">教师姓名：</label>
			<div class="formControls col-xs-8 col-sm-9">
				${course.realname }
			</div>
		</div>
		...
		<c:if test="${course.courselimit == 1}">
			<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<c:choose>
					...
					<c:when test="${course.courselimit == 2}">付费</c:when>
				</c:choose>
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<c:choose>
					...
					<c:when test="${course.flag == 2}">下架</c:when>
				</c:choose>
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<c:choose>
					...
					<c:when test="${course.auth == 2}">审核未通过</c:when>
				</c:choose>
			</div>
		</div>
		<div class="row cl">
