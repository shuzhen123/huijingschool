...
<article class="page-container">
	<form action="addmpbanner" method="post" enctype="multipart/form-data" class="form form-horizontal" id="form">
		<input type="text" class="hidden" value="0" name="link">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<div>
					<span class="btn-upload form-group">
						...
						<input type="file" name="vfile" class="input-file">
					</span>
				</div>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">图文内容：</label>
			<div class="formControls col-xs-8 col-sm-9"> 
...
$(function(){
	...
	$("#form").validate({
		...
		submitHandler:function(form){
			if($.trim($('input[name="vfile"]').val()) == ''){
				layer.msg('请选择展示图！',{icon: 7,time:2000});
				return false;
			}
			//检查编辑区域中是否有内容
			if(!ue.hasContents()) {layer.msg("文章内容不能为空",{icon: 7,time:1500}); return false;}
