...
<article class="page-container">
	<form action="editmpbanner" method="post" enctype="multipart/form-data" class="form form-horizontal" id="form">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">新缩略图：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<div>
					<span class="btn-upload form-group">
						<input class="input-text upload-url" type="text" name="uploadfile" id="uploadfile" readonly nullmsg="请添加附件！" style="width:200px">
						<a href="javascript:void();" class="btn btn-primary radius upload-btn"><i class="Hui-iconfont">&#xe642;</i> 上传缩略图</a>
